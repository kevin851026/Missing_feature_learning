...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('task3_moreF3.pkl'))
    ...
    for epoch in range(15000):
        ...
        if v_acc > max_acc :
            max_acc = v_acc
            torch.save(model.state_dict(), 'task3_moreF3'+'.pkl')
        ...
        draw_chart(chart_data,'task3_moreF3')
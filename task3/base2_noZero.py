...
class Dataset(Dataset):
    ...
    def __getitem__(self, index):
        if self.train:
            ...
            feature.drop(['F1','F2','F6'], inplace=True)
...
if __name__ == '__main__':
    ...
    model = Model(9-1-2, hidden_size, len(trainset.label_id))
    # model.load_state_dict(torch.load('task3_base2_noF26.pkl'))
    ...
    for epoch in range(15000):
        ...
        if v_acc > max_acc :
            max_acc = v_acc
            torch.save(model.state_dict(), 'task3_base2_noF26'+'.pkl')
        ...
        draw_chart(chart_data,'task3_base2_noF26')
...
class Model(nn.Module):
    ...
    def forward(self, features):
        ...
        regression6 = self.regression5(self.fc6(features))
        regression7 = self.regression5(self.fc7(features))
        ...
        logits = self.classifier(self.fc9(self.fc8(new_features)))
        return logits
     # 1
     # 2
     # 3
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('task3_moreF7.pkl'))
    ...
    for epoch in range(15000):
        ...
        if v_acc > max_acc :
            max_acc = v_acc
            torch.save(model.state_dict(), 'task3_moreF7'+'.pkl')
        ...
        draw_chart(chart_data,'task3_moreF7')
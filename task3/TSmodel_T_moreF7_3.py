...
class Model(nn.Module):
    ...
    def forward(self, features):
        ...
        regression2 = self.regression1(self.fc2(features))
        regression3 = self.regression1(self.fc3(features))
        regression4 = self.regression1(self.fc4(features))
        regression5 = self.regression1(self.fc5(features))
        regression6 = self.regression1(self.fc6(features))
        regression7 = self.regression1(self.fc7(features))
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('task3_moreF7_3.pkl'))
    ...
    for epoch in range(15000):
        ...
        if v_acc > max_acc :
            max_acc = v_acc
            torch.save(model.state_dict(), 'task3_moreF7_3'+'.pkl')
        ...
        draw_chart(chart_data,'task3_moreF7_3')
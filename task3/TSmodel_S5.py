...
from TSmodel_T_moreF7_2 import Model as Teacher
...
class Model(nn.Module):
    ...
    def forward(self, features):
        ...
        expand_features = torch.cat((features, generate1,generate2,generate3,generate4,generate5,generate6,generate7),dim=1)
...
class softCrossEntropy(nn.Module):
    ...
    def forward(self, inputs, target):
        ...
        :return: loss
        """
        log_likelihood = - F.log_softmax(inputs/24, dim=1)
...
if __name__ == '__main__':
    ...
    for epoch in range(15000):
        ...
        for step, (batch) in enumerate(train_loader):
            ...
            loss2 = criterion3(logits, F.softmax(t_sample/24,dim=1))

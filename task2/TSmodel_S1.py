...
class Teacher(nn.Module):
    def __init__(self, input_size,hidden_size,category_size):
        ...
        self.regression12 =  nn.Sequential(
                        nn.Linear(input_size,hidden_size*2),
                        nn.SELU(),
                        nn.Dropout(drop_pro),
                        nn.Linear(hidden_size*2,hidden_size*2),
        ...
        self.regression13 =  nn.Sequential(
                        nn.Linear(input_size,hidden_size*2),
                        nn.SELU(),
                        nn.Dropout(drop_pro),
                        nn.Linear(hidden_size*2,hidden_size*2),
        ...
        self.regression14 =  nn.Sequential(
                        nn.Linear(input_size,hidden_size*2),
                        nn.SELU(),
                        nn.Dropout(drop_pro),
                        nn.Linear(hidden_size*2,hidden_size*2),
        ...
        self.regression15 =  nn.Sequential(
                        nn.Linear(input_size,hidden_size*2),
                        nn.SELU(),
                        nn.Dropout(drop_pro),
                        nn.Linear(hidden_size*2,hidden_size*2),
        ...
        self.classifier =  nn.Sequential(
                        nn.Linear(input_size+15,hidden_size*2),
                        nn.SELU(),
                        nn.Dropout(drop_pro),
                        nn.Linear(hidden_size*2,hidden_size*2),
                        nn.SELU(),
    ...
    def forward(self, features):
        ...
        regression12 = self.regression12(features)
        regression13 = self.regression13(features)
        regression14 = self.regression14(features)
        regression15 = self.regression15(features)
        ...
        new_features = torch.cat((new_features, regression1,regression2,regression3,regression4,regression5\
            ...
            ,regression12,regression13,regression14,regression15),dim=1)
...
class Model(nn.Module):
    def __init__(self, input_size,hidden_size,category_size):
        ...
        self.classifier =  nn.Sequential(
                        nn.Linear(input_size+3+15,hidden_size*2),
                        nn.SELU(),
                        nn.Dropout(drop_pro),
                        nn.Linear(hidden_size*2,hidden_size*2),
                        nn.SELU(),
    ...
    def forward(self, features):
        ...
        generate12 = self.generate12(new_features)
        generate13 = self.generate13(new_features)
        generate14 = self.generate14(new_features)
        generate15 = self.generate15(new_features)

        expand_features = torch.cat((new_features, generate1,generate2,generate3,generate4,generate5\
                            ,generate6,generate7,generate8,generate9,generate10,generate11\
                            ,generate12,generate13,generate14,generate15),dim=1)
        logits = self.classifier(expand_features)

        return logits,\
               torch.cat((regression1,regression2,regression3),dim=1),\
               torch.cat((generate1,generate2,generate3,generate4,generate5\
                            ,generate6,generate7,generate8,generate9,generate10,generate11\
                            ,generate12,generate13,generate14,generate15),dim=1)
...
if __name__ == '__main__':
    ...
    teacher.load_state_dict(torch.load('task2_moreF15.pkl'))
    model.load_state_dict(torch.load('task3_student_1.pkl'))
    ...
    for epoch in range(15000):
        ...
        if v_acc > max_acc :
            max_acc = v_acc
            torch.save(model.state_dict(), 'task3_student_1'+'.pkl')
        ...
        draw_chart(chart_data,'task3_student_1')
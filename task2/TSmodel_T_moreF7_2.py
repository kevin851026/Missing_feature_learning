...
class Model(nn.Module):
    ...
    def forward(self, features):
        ...
        regression8 = self.regression8(self.fc8(features))
        regression9 = self.regression9(self.fc9(features))
        ...
        logits = self.classifier(self.fc11(self.fc10(new_features)))
        return logits
...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load('task2_moreF7_3.pkl'))
    ...
    for epoch in range(15000):
        ...
        if v_acc > max_acc :
            max_acc = v_acc
            torch.save(model.state_dict(), 'task2_moreF7_3'+'.pkl')
        ...
        draw_chart(chart_data,'task2_moreF7_3')
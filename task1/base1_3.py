...
if __name__ == '__main__':
    ...
    model = Model(10, hidden_size, len(trainset.label_id))
    # model.load_state_dict(torch.load('model_base1_randomask.pkl'))
    ...
    for epoch in range(15000):
        ...
        if v_acc > max_acc :
            max_acc = v_acc
            torch.save(model.state_dict(), 'model_base1_randomask'+'.pkl')
        ...
        draw_chart(chart_data,'model_base1_randomask')
...
class Model(nn.Module):
    ...
    def forward(self, features):
        ...
        new_features.T[0] = regression.view(-1)
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('model_base3_2_share.pkl'))
    ...
    for epoch in range(15000):
        ...
        if v_acc > max_acc :
            max_acc = v_acc
            torch.save(model.state_dict(), 'model_base3_2_share'+'.pkl')
        ...
        draw_chart(chart_data,'model_base3_2_share')